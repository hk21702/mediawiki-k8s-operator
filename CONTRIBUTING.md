...
This document explains the processes and practices recommended for contributing enhancements to the MediaWiki charm.
...
Canonical welcomes contributions to the MediaWiki charm. Please check out our
...
```
git clone https://github.com/canonical/MediaWiki
```
...
OCI image for the MediaWiki app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./mediawiki-k8s*.charm 
```
