...
For information about how to deploy, integrate, and manage this charm, see the Official [MediaWiki K8s charm documentation]().
...
- [Official webpage](https://www.mediawiki.org) <!--(Optional) Link to official upstream webpage/blog/marketing content-->
...
The MediaWiki logo ([`icon.svg`](icon.svg)) is licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
